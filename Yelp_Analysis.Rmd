...
USmap <- gvisGeoChart(counts, "loc", 
                          ...
                          options=list(region = 'US',
                                       displayMode = "markers",
                                       colorAxis="{colors:['white', 'col="#c41200"']}"))
...
cat("<center>")
print(gvisMerge(USmap, Europemap, horizontal=FALSE), "chart")
cat("</center>")
```
...
dataset <- left_join(dataset, all_restaurants[c(1,119:length(all_restaurants))], by = "businessid")
